...
CREATE TABLE `account` (
                           ...
                           PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6688522 DEFAULT CHARSET=utf8 COMMENT '账号表';
...
CREATE TABLE `balance` (
                           ...
                           PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1556 DEFAULT CHARSET=utf8 COMMENT '账号资产表';
...
) ENGINE=MyISAM AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT '交易订单表';
...
CREATE TABLE `order_profit` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT '订单套利收益表';
...
CREATE TABLE `robot` (
                         ...
                         PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT '策略运行机器人记录';
...
CREATE TABLE `strategy` (
                            ...
                            PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT '策略表';
